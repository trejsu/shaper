...
def test_get_reward_config_for_single_reward_type():
    n = 10
    config = Config(n=n, rewards='mse', rewards_thresholds='1')
...
def test_get_reward_config_for_double_reward_type():
    n = 20
    config = Config(n=n, rewards='mse,l2', rewards_thresholds='1,10')
...
def test_get_reward_config_for_triple_reward_type():
    n = 20
    config = Config(n=n, rewards='mse,l2,l1', rewards_thresholds='1,10,15')
